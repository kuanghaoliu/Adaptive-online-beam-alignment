...
params.active_BS = 1:12;             % Includes the numbers of the active BSs (values from 1-18 for 'O1')(check the scenario description at https://deepmimo.net/scenarios/ for the BS numbers) 
...
params.active_user_last = 2751;        % The last row of the considered user section (check the scenario description for the user row map)
...
params.generate_OFDM_channels = 0;    % 1: activate frequency domain (FD) channel generation for OFDM systems
